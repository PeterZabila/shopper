    ...
    return (
      <Container>
        ...
        <Right>
          <Title>Contact</Title>
          <ContactItem>
            <Room style={{marginRight:"10px"}}/> 7 Heroiv Dnipra Street
          </ContactItem>
          <ContactItem>
            <Phone style={{marginRight:"10px"}}/> +38093 381 11 35
          </ContactItem>
          <ContactItem>
            <MailOutline style={{marginRight:"10px"}} /> petrozabila@gmail.com
          </ContactItem>
          <Payment src={payment} />
        </Right>
      </Container>
